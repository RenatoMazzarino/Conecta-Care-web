...
export const professionals: Professional[] = [
  {
    ...
    address: { street: 'Rua das Enfermeiras, 10', neighborhood: 'Saúde', city: 'São Paulo', state: 'SP', zipCode: '04300-000' },
  ...
  },
  {
    ...
    address: { street: 'Av. das Américas, 2000', neighborhood: 'Barra da Tijuca', city: 'Rio de Janeiro', state: 'RJ', zipCode: '22640-100' },
  ...
  },
  {
    ...
    address: { street: 'Rua dos Inconfidentes, 50', neighborhood: 'Funcionários', city: 'Belo Horizonte', state: 'MG', zipCode: '30140-120' },
    ...
    address: { street: 'Rua Augusta, 900', neighborhood: 'Consolação', city: 'São Paulo', state: 'SP', zipCode: '01304-001' },
  ...
  },
  {
    ...
    address: { street: 'Rua das Araucárias, 150', neighborhood: 'Batel', city: 'Curitiba', state: 'PR', zipCode: '80420-190' },
  ...
  },
  {
    ...
    address: { street: 'Av. Ipiranga, 3000', neighborhood: 'Partenon', city: 'Porto Alegre', state: 'RS', zipCode: '90610-000' },
  ...
  },
  {
    ...
    address: { street: 'Av. Oceânica, 400', neighborhood: 'Barra', city: 'Salvador', state: 'BA', zipCode: '40140-130' },
