    ...
    return (
        <Card>
            ...
            <CardContent className="relative py-6">
                ...
                <div
                    className="absolute left-4 top-6 bottom-6 w-2 bg-muted rounded-full overflow-hidden"
                >
                    <div
                ...
                {/* Container para os eventos da timeline */}
                <div className="relative flex flex-col gap-8">
                     {mockShiftHistory.map((event, index) => {
                        ...
                        const isLast = index === mockShiftHistory.length - 1;
