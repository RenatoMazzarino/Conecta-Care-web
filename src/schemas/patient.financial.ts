...
export const PatientFinancialZ = z.object({
  ...
  bond_type: z
    .enum(["Plano de Saúde", "Particular", "Convênio", "SUS", "Parceria"])
    .optional(),
  ...
  payment_method: z
    .enum(["Boleto", "PIX", "Débito", "Transferência", "Faturamento", "Outro"])
    .optional(),
  billing_status: z
    .enum(["Em dia", "Atrasado", "Em negociação", "Inadimplente", "Isento"])
    .optional(),
